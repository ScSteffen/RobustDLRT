...
def save_cifar10_images(base_dir):
    ...
    image_dir = os.path.join(base_dir, "Cifar10/images")
...
if __name__ == "__main__":
    base_directory = "./data_adversarial_rs"  # Change this path as needed
    save_cifar10_images(base_directory)
    # sort_text_file(os.path.join(base_directory, "Cifar10_train.txt"))
    # sort_text_file(os.path.join(base_directory, "Cifar10_test.txt"))
